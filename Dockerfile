...
LABEL maintainer="OZ" \
  ...
  org.opencontainers.image.url="https://github.com/garyosbourne/Varken" \
  org.opencontainers.image.source="https://github.com/garyosbourne/Varken" \
  org.opencontainers.image.version=$VERSION \
  org.opencontainers.image.revision=$VCS_REF \
  org.opencontainers.image.vendor="OZ" \
